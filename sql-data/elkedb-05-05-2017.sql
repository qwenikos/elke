...
CREATE TABLE `base_doc_proypologismos` (
  ...
  `table_4C` varchar(45) DEFAULT NULL,
  ...
  PRIMARY KEY (`rec_id`),
  CONSTRAINT `fk_base_doc_proypologismos_1` FOREIGN KEY (`rec_id`) REFERENCES `base_scidir` (`rec_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_base_doc_proypologismos_2` FOREIGN KEY (`rec_id`) REFERENCES `base_research` (`rec_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-05-05 15:09:49
